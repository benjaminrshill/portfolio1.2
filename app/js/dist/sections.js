...
elements.modal.addEventListener('touchstart', startTouch, {
  passive: true
});
elements.modal.addEventListener('touchmove', moveTouch, {
  passive: true
});
elements.modal.addEventListener('touchend', endTouch, {
  passive: true
});
