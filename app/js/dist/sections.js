...
function switchContent(i) {
  ...
  elements.modal.innerHTML = '<div>' + '<div id="itemTitles">' + '<h3 style="padding-left: ' + 10 / letters + 'vw' + '; font-size: ' + 80 / letters + 'vw' + '; letter-spacing: ' + 10 / letters + 'vw' + '; line-height: ' + (10 + (letters > 10 ? letters - 4 : letters)) + 'vh">' + items[i][0].title + '</h3>' + '</div>' + '<div id="itemBody">' + url + '<h5>' + items[i][0].tools + '</h5>' + '<p>' + pDesc + '</p>' + '</div>' + '</div>';
}
